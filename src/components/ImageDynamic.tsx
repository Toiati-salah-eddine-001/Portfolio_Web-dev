...
const Scene = dynamic(() => import("@/components/ui/image-ripple"), {
  loading: () => (
    <div
      role="status"
...
<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <filter id="noiseFilter" x="0" y="0" width="100%" height="100%">
      ...
      <feTurbulence type="fractalNoise" baseFrequency="0.7" numOctaves="3" stitchTiles="stitch" result="turb"/>
  ...
  <rect width="100%" height="100%" fill="#777" filter="url(#noiseFilter)"/>
</svg>
