...
export function SectionTitle({ 
  ...
  return (
    <div className={`flex flex-col items-center ${className}`}>
      <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold text-center text-gray-800 dark:text-white mb-4 ${titleClassName}`}>
        {children}
      </h2>
      <div className={`w-full max-w-[280px] h-4 -mt-2 px-4 sm:px-0 ${waveClassName}`}>
        <svg 
