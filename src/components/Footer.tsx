        ...
        >
            <div className="w-full max-w-9xl mx-auto">
                <div className="relative mb-16">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-center bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent relative z-10">
                        Connect With Me
                        <div className="absolute top-9 right-[-900px] transform -translate-x-1/2 w-3/4 h-10 -z-10">
                            <svg 
